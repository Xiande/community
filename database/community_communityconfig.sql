...
--
-- Table structure for table `communityconfig`
--
...
CREATE TABLE `communityconfig` (
  ...
  `ConfigDescription` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `communityconfig`
--

LOCK TABLES `communityconfig` WRITE;
/*!40000 ALTER TABLE `communityconfig` DISABLE KEYS */;
/*!40000 ALTER TABLE `communityconfig` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-11-17 15:41:22
