...
CREATE TABLE `badgecategory` (
  ...
  `BadageImageUrl` varchar(45) DEFAULT NULL,
  `BadgeENDescription` varchar(500) DEFAULT NULL,
  `BadgeCNDescription` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
LOCK TABLES `badgecategory` WRITE;
